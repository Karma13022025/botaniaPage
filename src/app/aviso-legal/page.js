        ...
        <main className={styles.contenedor}>
            ...
            <section className={styles.contenido}>
                <div className={styles.seccion}>
                    ...
                    <p>
                        Estos productos son complementos naturales diseñados para contribuir al bienestar general.
                        Su uso no garantiza la cura de enfermedades ni reemplaza el diagnóstico o tratamiento
                ...
                <div className={styles.seccion}>
                    ...
                    <ul>
                        <li>Consulta siempre a tu médico antes de iniciar cualquier tratamiento complementario.</li>
                        <li>No suspendas medicamentos prescritos sin la aprobación de un profesional de la salud.</li>
                        <li>Si estás embarazada, en periodo de lactancia o padeces alguna condición crónica, consulta con tu médico antes de consumir cualquier producto herbolario.</li>
                        <li>En caso de reacción adversa, suspende el uso del producto inmediatamente y acude a tu médico.</li>
                    </ul>
                </div>
