...
// SEO específico para la página de contacto y citas.
...
/**
 * Página de contacto y agenda de citas.
 * Ofrece CTAs directos (teléfono/WhatsApp), datos de contacto y un pequeño FAQ.
 */
      ...
      <section className={styles.infoContacto}>
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoCard}>
            ...
            <p className={styles.infoDetalle}>
      ...
      <section className={styles.faq}>
        ...
        <div className={styles.faqGrid}>
          <div className={styles.faqCard}>
            ...
            {/* PLACEHOLDER */}
            <p>
              Sí, todas nuestras sesiones son con cita previa para garantizar
              una atención personalizada y dedicada.
            </p>
          </div>
          <div className={styles.faqCard}>
            ...
            {/* PLACEHOLDER */}
            <p>
              Las sesiones varían de 45 minutos a 60 minutos dependiendo de la
          ...
          <div className={styles.faqCard}>
            ...
            {/* PLACEHOLDER */}
            <p>
              Solo necesitas traer ropa cómoda y una actitud abierta. Nosotros
          ...
          <div className={styles.faqCard}>
            ...
            {/* PLACEHOLDER */}
            <p>
              Por el momento todas nuestras sesiones son presenciales para poder
